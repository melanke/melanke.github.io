...
export const timelineItems: TimelineEntry[] = [
  {
    ...
    description: {
      general:
        "At 33Labs (formerly 33Audits), I've worked on the design and development of advanced DeFi protocols, focusing on composability, capital efficiency, and developer experience.\n\nThe company began as a smart contract auditing firm, which has given me hands-on, daily experience identifying and preventing vulnerabilities. I've developed protocols end to end — architecture, implementation, and testing — with security and gas optimization as constant priorities. That led me to a key conviction: the auditing process should start at the architecture stage, before any code is written. On Mosaic I built the AI-assisted tooling that turns natural-language specs into composable contract compositions, and put LLM agents to work across the audit workflow — parallel sub-agents analyzing independent contract modules, then a staged recon-to-depth review pipeline.",
      web3:
