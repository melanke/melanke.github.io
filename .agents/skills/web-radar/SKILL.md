...
Read `.agents/skills/_shared/webdev-news-sources.md` — it is the live source of truth for
...
(only if the user wants hooks): `.agents/skills/_shared/professional-background.md` (→ portfolio
source) and `.agents/skills/_shared/author-voice.md`.
...
- **Keep the catalog alive.** Dead endpoints, moved repos, invalid tags, or a consistently-
  useless source → update `.agents/skills/_shared/webdev-news-sources.md`.
