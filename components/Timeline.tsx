  ...
  return (
    <div className="flex flex-col mt-10 w-full text-black dark:text-white max-md:max-w-full">
      ...
      <TimelineItem
        ...
        technologies={["TS", "React", "NextJS", "NodeJS", "Contract"]}
      ...
      <TimelineItem
        ...
        technologies={["TS", "NodeJS", "Blockchain"]}
      ...
      <TimelineItem
        ...
        technologies={["TS", "React", "React Native", "Blockchain"]}
        title="Neon Wallet"
        role="Software Engineer | TechLead"
      ...
      <TimelineItem
        ...
        technologies={["React", "Kotlin", "Java"]}
        title="NDapp"
        role="Software Engineer | TechLead"
      ...
      <TimelineItem
        ...
        technologies={["TS", "React", "Kotlin", "Java", "Jersey", "MySQL"]}
        title="Wow Talents"
        role="Software Engineer | TechLead"
      ...
      <TimelineItem
        ...
        technologies={["TS", "React", "Kotlin", "Java", "MySQL"]}
