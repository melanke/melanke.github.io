...
| ai-agents-need-iam-more-than-prompts | AI Agents Need IAM More Than Prompts | Two 2025 incidents where a coding agent nearly wiped production, and why AWS's security team, OWASP, and Okta are all converging on treating agents as a scoped, first-class identity rather than trusting a better-written prompt. | AI, AI Agents, AWS, IAM, Security, MCP |
